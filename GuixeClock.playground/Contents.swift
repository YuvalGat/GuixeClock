/*:
 ...
 To get started, open the Assistant Editor and drag the view divider to the left, until you see the whole frame, then press run (a triangular-looking button at the bottom of the screen).
